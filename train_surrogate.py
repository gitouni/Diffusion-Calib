...
def main(config:Dict, config_path:str):
    ...
    surrogate_model:SURROGATE_TYPE = DenoiserDict[config['model']['surrogate']['type']](**config['model']['surrogate']['argv']).to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_config",type=str,default="cfg/sd_model/lccraft_small_sd.yml")
