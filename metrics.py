...
def options():
    ...
    parser.add_argument("--pred_dir_root",type=str,default="experiments/large/lccraft/kitti/results/se3_diffusion_10")
    parser.add_argument("--gt_dir",type=str,default="cache/kitti_gt")
    parser.add_argument("--log_file",type=str,default="log/large/lccraft_sd.json")
