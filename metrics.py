...
def options():
    ...
    parser.add_argument("--pred_dir_root",type=str,default="experiments/resize/calibnet/kitti/results/iterative_10")
    parser.add_argument("--gt_dir",type=str,default="cache/kitti_gt")
    parser.add_argument("--log_file",type=str,default="log/calibnet_iter10.log")
...
if __name__ == "__main__":
    ...
    pprint(metrics, open(args.log_file,'a'))
