...
def options():
    ...
    parser.add_argument("--image_dir",type=str,default="data/kitti/sequences/21/image_2")
    parser.add_argument("--lidar_dir",type=str,default="data/kitti/sequences/21/velodyne")
    parser.add_argument("--gt_mat",type=str,default="data/colmap/21/gt.txt")
    parser.add_argument("--x0_dir",type=str,default="experiments/large/main/kitti/results/se3_diffusion_10/seq_21/")
    parser.add_argument("--index",type=int,default=141)
...
if __name__ == "__main__":
    ...
    for t, xt in enumerate(reversed(x0)):
