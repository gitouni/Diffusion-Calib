...
def options():
    ...
    parser.add_argument("--x0_dir",type=str,default="experiments/large/main/kitti/results/se3_diffusion_10/seq_13/")
    parser.add_argument("--index",type=int,default=287)
