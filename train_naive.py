...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_config', type=str, default="cfg/dataset/nusc_naiter.yml")
    parser.add_argument("--model_config",type=str, default="cfg/naiter_model/main.yml")
